...
The functions `add_ref_box()`, `add_ref_line()`, and `add_glyph_legend()` are compatible with either *ymin_minor*, *ymax_minor*, or *y_minor*, *yend_minor*. Additionally, `sugarglider` introduces several customizable options to tailor the visual aspects further:
